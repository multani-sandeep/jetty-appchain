...
appdB2B="-javaagent:$APPD_AGENT_JAR -Dappdynamics.agent.applicationName=$APPD_AGENT_APP_NAME -Dappdynamics.agent.nodeName="$APPD_AGENT_NODE_NAME_PREFIX"App9 -Dappagent.install.dir=$APPD_AGENT_HOME -Dappdynamics.agent.tierName=B2B -Djetty.jmxrmiport=2008"
